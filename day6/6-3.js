// for of 요소 값을 변수에 복사. 좌변에 선언한 변수를 이용하여 배열을 간접적으로 읽을 수 있음.
// 원본 배열 요소값 변경 불가능.

// 문자열 전부 검색.
// 찾으려는 값이 없으면 -1 값을 반환함.
// 찾으려는 인덱스 다음 값
...
//     console.log(ch);           // for of 요소 값을 변수에 복사. 좌변에 선언한 변수를 이용하여 배열을 간접적으로 읽을 수 있음.
//                             // 원본 배열 요소값 변경은 불가능.
// }
// console.log();
...
// console.log(str.lastIndexOf('t')); // 역순 검색.
// console.log();
