...
- 문자열 양쪽 끝의 공백을 제거한 새로운 문자열을 반환. 
여기서 공백은 space, tab, NBSP, 개행문자(\n).
*/
// console.log(str1);
...
// console.log(str2.slice(-6));        // slice 오른쪽부터 음수 인덱싱
// console.log();
...
// console.log(str3.replace('sub', 'main'));    // 첫번째 검색 값 반환.
// console.log(str3);
// console.log(str3.replace('middle', 'center')); // 대응되는 문자열 없으면 원본 문자열 반환.
// console.log();


const str4 = 'Uses a regular expression';

// console.log(str4.split());       // 입력 x > 전체를 요소 하나로 반환.

// console.log(str4.split(''));     // 빈 문자열로 지정 > 대상 문자열의 모든 문자들을 배열 요소들로 반환.
