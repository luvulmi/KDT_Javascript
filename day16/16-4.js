...
btn[3].addEventListener('click', function () {
    ...
    */
    ...
    popup1 = open('./16-5.html', '팝업창1', 'width=300px, height=300px');
...
btn[4].addEventListener('click', () => {
    ...
    */
    ...
    - 브러우저 창의 참조를 통해 창의 너비와 높이를 outerWidth 와 outerHeight 로 동적
      변경 가능한 메서드.
    */
    popup2 = open('./16-5.html', '팝업창2', `width=300px, height=300px, left=${locationX}px, top=${locationY}px`);
    popup2.resizeTo(300, 300); // outer로 변경을 해줌.
